...
show tables;
insert into employee(name, gender, phone_number, address,startDate)values ('Renu', 'F','9843256578','TS','2021-01-10');
insert into employee(name, gender, phone_number, address,startDate)values ('Divya', 'F','7656565645','Mumbai','2021-10-01');
insert into employee(name, gender, phone_number, address,startDate)
values ('sam', 'M','8675675656','AP','2021-01-04');
insert into employee(name, gender, phone_number, address,startDate)values ('', 'M','9745643534','TN','2021-04-10');
...
insert into employee(name, gender, phone_number, address,startDate)values ('Terissa', 'f','9895689865','NY','2021-04-10');
